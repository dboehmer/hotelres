...
$guests=good_query_table("SELECT CONCAT(firstname,' ',lastname) AS name, persons, end, bookings.id AS booking FROM guests,bookings WHERE begin=CURRENT_DATE() AND guests.id=bookings.guest");
