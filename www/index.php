...
if (count($guests)==0)
...
else
    {
        ...
        foreach ($guests as $guest)
            {
                echo '<tr><td>'.$guest['name'].'</td><td style="text-align:center;">'.$guest['persons'].'</td><td>'.own_date_format("%d.%m.%Y",$guest['end'],(60*60*24)).'</td><td><a href="schedule.php?edit='.$guest['booking'].'">Details</a></td></tr>';
            }
        echo '</table>';
    }
